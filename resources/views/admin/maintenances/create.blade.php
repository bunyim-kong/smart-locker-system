...
<body>
    ...
    <form action="{{ route('maintenances.store') }}" method="POST">
        ...
        <div>
            ...
            <textarea name="issue_des" id="issue_des" rows="4" maxlength="1000" required>{{ old('issue_des') }}</textarea>
            @error('issue_des')
                <div>{{ $message }}</div>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="date" name="report_date" id="report_date" value="{{ old('report_date') }}" required>
            @error('report_date')
                <div>{{ $message }}</div>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="date" name="resolve_date" id="resolve_date" value="{{ old('resolve_date') }}" required>
            @error('resolve_date')
                <div>{{ $message }}</div>
            @enderror
        </div>
